...
/**
  * ParallelRegexTokenizerTest
  *
  * Unit tests for [[ParallelRegexTokenizer]].
  *
  * @author belbis
  * @since 1.0.0
  */
class ParallelRegexTokenizerTest extends TestBase {
  ...
  "#transform()" should "transform a dataframe" in {
    ...
    val prt = new ParallelRegexTokenizer()
      .setPattern("\\W")
      .setInputCols(Array("_2", "_3", "_4"))
      .setOutputCols(Array("_2_tok", "_3_tok", "_4_tok"))

    val out = prt.transform(df).select("_2_tok", "_3_tok", "_4_tok").collect
